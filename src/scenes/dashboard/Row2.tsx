...
import { ResponsiveContainer, ScatterChart, Scatter, LineChart, Line, XAxis, YAxis, ZAxis, Tooltip, CartesianGrid, Pie, PieChart, Cell } from "recharts";
  ...
  return (
    ...
    <DashboardBox gridArea="e">
      ...
      <Box flexBasis="40%" >
        ...
        <Typography variant="h6">Losses are down 27%</Typography>
        <Typography mt="0.4rem" variant="h5">Profit Margins</Typography>
        <Typography variant="h6">Margins are up 33% from last month</Typography>
      </Box>
      </FlexBetween>
    </DashboardBox>
