...
import { ResponsiveContainer,BarChart,Bar, AreaChart, LineChart, Line, XAxis, YAxis, Tooltip, Area, CartesianGrid, Legend } from "recharts";
  ...
  return ( <>
    ...
    <DashboardBox gridArea="c">
      <BoxHeader
          ...
          subtitle="graph shows revenue month by month"
          sideText="+4%"
        />
      <ResponsiveContainer width="100%" height="100%">
          <BarChart
